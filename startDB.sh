...
podman run --name db -p 32000:3306 -v ./data:/var/lib/mysql -v ./db/init.sql:/docker-entrypoint-initdb.d/init.sql -e MYSQL_ROOT_PASSWORD=root -d docker.io/mysql:8.3.0
